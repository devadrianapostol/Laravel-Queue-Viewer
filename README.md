...
## Installation
1. Build the plugin: Run `./gradlew build` in the project root.
2. Install in PhpStorm: Preferences > Plugins > Gear Icon > Install Plugin from Disk > Select `build/distributions/*.zip`.
3. Restart PhpStorm.
4. Open: View > Tool Windows > Laravel Queue (or menu: View > Open Laravel Queue).
...
What surprises you most about queue inspection? Ready to add retry/delete actions?
